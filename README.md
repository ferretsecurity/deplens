...
The old default `python-poetry-lock` behavior reported `poetry.lock` only as a generic match:
...
Now the dedicated parser extracts retained package entries directly and skips git-sourced packages:
