...
func TestComposerLockParserFixtureCoverage(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			if !slices.Equal(dependencyNames(result.Dependencies), tc.wantDeps) {
