...
| 46 | Java (Gradle) | Manifest | `gradle/libs.versions.toml` | Version catalog. | 1 | path-glob | [default_rules.yaml](internal/analyze/default_rules.yaml) | [scan_test.go](internal/analyze/scan_test.go) | [testdata/java/gradle-version-catalog](testdata/java/gradle-version-catalog) |
| 47 | Java (Gradle) | Config | `gradle/wrapper/gradle-wrapper.properties` | Gradle distribution pin. | 1 | path-glob | [default_rules.yaml](internal/analyze/default_rules.yaml) | [scan_test.go](internal/analyze/scan_test.go) | [testdata/java/gradle-wrapper](testdata/java/gradle-wrapper) |
...
| 56 | Scala (sbt) | Manifest | `project/plugins.sbt` | sbt plugin declarations. | 1 | path-glob | [default_rules.yaml](internal/analyze/default_rules.yaml) | [scan_test.go](internal/analyze/scan_test.go) | [testdata/scala/sbt-plugins](testdata/scala/sbt-plugins) |
| 57 | Scala (sbt) | Manifest | `project/Dependencies.scala` | sbt dependency object. | 1 | path-glob | [default_rules.yaml](internal/analyze/default_rules.yaml) | [scan_test.go](internal/analyze/scan_test.go) | [testdata/scala/sbt-dependencies](testdata/scala/sbt-dependencies) |
| 58 | Scala (sbt) | Config | `project/build.properties` | sbt version pin. | 1 | path-glob | [default_rules.yaml](internal/analyze/default_rules.yaml) | [scan_test.go](internal/analyze/scan_test.go) | [testdata/scala/sbt-build-props](testdata/scala/sbt-build-props) |
...
| 63 | Ruby | Manifest (variants) | `gemfiles/*.gemfile` | Appraisal gemfile variants. | 1 | path-glob | [default_rules.yaml](internal/analyze/default_rules.yaml) | [scan_test.go](internal/analyze/scan_test.go) | [testdata/ruby/appraisal](testdata/ruby/appraisal) |
...
| 76 | Go (godep) | Legacy manifest | `Godeps/Godeps.json` | Legacy godep manifest. | 1 | path-glob | [default_rules.yaml](internal/analyze/default_rules.yaml) | [scan_test.go](internal/analyze/scan_test.go) | [testdata/go/godep](testdata/go/godep) |
...
| 82 | Rust | Config | `.cargo/config.toml` | Source replacement / registry overrides. | 1 | path-glob | [default_rules.yaml](internal/analyze/default_rules.yaml) | [scan_test.go](internal/analyze/scan_test.go) | [testdata/rust/cargo-config](testdata/rust/cargo-config) |
...
| 91 | C# / .NET | Config | `.config/dotnet-tools.json` | .NET local tool manifest. | 1 | path-glob | [default_rules.yaml](internal/analyze/default_rules.yaml) | [scan_test.go](internal/analyze/scan_test.go) | [testdata/dotnet/tools-manifest](testdata/dotnet/tools-manifest) |
...
| 96 | C / C++ (CMake) | Config | `cmake/*.cmake` | Find modules. | 1 | path-glob | [default_rules.yaml](internal/analyze/default_rules.yaml) | [scan_test.go](internal/analyze/scan_test.go) | [testdata/cpp/cmake-modules](testdata/cpp/cmake-modules) |
...
| 103 | C / C++ (Meson) | Manifest | `subprojects/*.wrap` | `.wrap` dep fetch descriptors. | 1 | path-glob | [default_rules.yaml](internal/analyze/default_rules.yaml) | [scan_test.go](internal/analyze/scan_test.go) | [testdata/cpp/meson-wrap](testdata/cpp/meson-wrap) |
...
| 105 | C / C++ (Google) | Manifest | `DEPS` | gclient-style multi-repo dep fetch. Rule drafted (`cpp-gclient-deps`, root-only path-glob); commented out pending Level 2 content check. | - | Not implemented | — | — | — |
...
| 136 | R | Manifest | `DESCRIPTION` | `Imports:`, `Depends:` fields. Rule drafted (`r-description`, `^DESCRIPTION$`); commented out pending Level 2 DCF content check. | - | Not implemented | — | — | — |
...
| 138 | R (packrat) | Legacy lockfile | `packrat/packrat.lock` | Legacy packrat lockfile. | 1 | path-glob | [default_rules.yaml](internal/analyze/default_rules.yaml) | [scan_test.go](internal/analyze/scan_test.go) | [testdata/r/packrat-lock](testdata/r/packrat-lock) |
...
| 155 | OCaml (Dune) | Config | `dune` | Per-directory build rules. Rule drafted (`ocaml-dune`, `^dune$`); commented out pending Level 2 s-expression content check. | - | Not implemented | — | — | — |
...
| 177 | GitHub Actions | Manifest-like | `.github/workflows/*.yml` | `uses: org/action@version`. Path-glob detects `.yml` files in `.github/workflows/`. | 1 | path-glob | [default_rules.yaml](internal/analyze/default_rules.yaml) | [scan_test.go](internal/analyze/scan_test.go) | [testdata/github/actions-workflow](testdata/github/actions-workflow) |
...
| 180 | Unity | Lockfile | `Packages/packages-lock.json` | Unity package lockfile. | 1 | path-glob | [default_rules.yaml](internal/analyze/default_rules.yaml) | [scan_test.go](internal/analyze/scan_test.go) | [testdata/unity/packages-lock](testdata/unity/packages-lock) |
...
| 202 | Bazel | Config | `BUILD` / `BUILD.bazel` | Per-package. `BUILD.bazel` detected by `bazel-build-file`; bare `BUILD` drafted (`bazel-build-file-bare`, `^BUILD$`) but commented out pending Level 2 content check. | 1 | filename-regex | [default_rules.yaml](internal/analyze/default_rules.yaml) | [scan_test.go](internal/analyze/scan_test.go) | [testdata/bazel/build-bazel](testdata/bazel/build-bazel) |
| 203 | Bazel | Config | `*.bzl` in `third_party/` | Starlark dep fetch rules. | 1 | path-glob | [default_rules.yaml](internal/analyze/default_rules.yaml) | [scan_test.go](internal/analyze/scan_test.go) | [testdata/bazel/third-party-bzl](testdata/bazel/third-party-bzl) |
...
| 205 | Nx | Config | `project.json` | Per-project config. Rule drafted (`js-nx-project`, `^project\.json$`); commented out pending Level 2 `json exists-any: targets,implicitDependencies` check. | - | Not implemented | — | — | — |
...
| 209 | Rush | Config | `common/config/rush/common-versions.json` | Rush shared version overrides. | 1 | path-glob | [default_rules.yaml](internal/analyze/default_rules.yaml) | [scan_test.go](internal/analyze/scan_test.go) | [testdata/rush/common-versions](testdata/rush/common-versions) |
...
| 212 | Pants | Manifest | `BUILD` files | Per-directory targets. Would share `bazel-build-file-bare` with Bazel; rule commented out pending Level 2 content check. | - | Not implemented | — | — | — |
...
| 214 | Pants | Manifest | `3rdparty/jvm/BUILD` | JVM third-party dep definitions. | 1 | path-glob | [default_rules.yaml](internal/analyze/default_rules.yaml) | [scan_test.go](internal/analyze/scan_test.go) | [testdata/pants/jvm-build](testdata/pants/jvm-build) |
...
| 221 | Puppet | Manifest | `metadata.json` | Cookbook metadata. Rule drafted (`puppet-cookbook-metadata`, path-glob `**/cookbooks/*/metadata.json`); commented out pending Level 2 JSON field check. | - | Not implemented | — | — | — |
