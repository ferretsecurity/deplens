...
| 2 | Python (pip) | Manifest | `constraints.txt` | Version constraints without declaring deps. | - | Not implemented | — | — | — |
...
| 18 | Python (Conda) | Manifest | `conda.yaml` | Alternative name. Rule regex `^environment\.ya?ml$` matches `environment.yml`/`environment.yaml` only, NOT `conda.yaml`. | - | Not implemented | — | — | — |
...
| 27 | JavaScript (Yarn Berry) | Config | `.pnp.cjs` / `.pnp.loader.mjs` | Plug'n'Play dependency map. No rule. | - | Not implemented | — | — | — |
...
| 29 | JavaScript (pnpm) | Workspace | `pnpm-workspace.yaml` | Monorepo workspace declaration. No rule. | - | Not implemented | — | — | — |
...
| 33 | JavaScript | Config | `.npmrc` | Registry config. No rule. | - | Not implemented | — | — | — |
| 34 | JavaScript | Config | `.yarnrc.yml` | Yarn Berry config. No rule. | - | Not implemented | — | — | — |
...
| 37 | JavaScript (Import Maps) | Manifest | `importmap.json` | Standalone JSON import map file. No rule for the file itself. Inline `<script type="importmap">` in HTML is handled by the html-external-scripts rule. | - | Not implemented (standalone file) | — | — | — |
...
| 84 | C# / .NET | Manifest | `*.fsproj` | F# project file. No rule (`dotnet-csproj` rule is `.*\.csproj$` only). | - | Not implemented | — | — | — |
| 85 | C# / .NET | Manifest | `*.vbproj` | VB.NET project file. No rule. | - | Not implemented | — | — | — |
...
| 87 | C# / .NET | Config | `Directory.Build.props` | Shared MSBuild properties. No rule. | - | Not implemented | — | — | — |
| 88 | C# / .NET | Config | `Directory.Build.targets` | Shared MSBuild targets. No rule. | - | Not implemented | — | — | — |
...
| 94 | C# / .NET (Paket) | Manifest | `paket.references` | Per-project dep list. No rule. | - | Not implemented | — | — | — |
| 95 | C / C++ (CMake) | Manifest | `CMakeLists.txt` | `find_package()` / `FetchContent_Declare()`. No rule. | - | Not implemented | — | — | — |
...
| 98 | C / C++ (Conan) | Manifest | `conanfile.py` | Python script form. No rule. | - | Not implemented | — | — | — |
...
| 101 | C / C++ (vcpkg) | Config | `vcpkg-configuration.json` | Registry config. No rule. | - | Not implemented | — | — | — |
| 102 | C / C++ (Meson) | Manifest | `meson.build` | No rule. | - | Not implemented | — | — | — |
| 103 | C / C++ (Meson) | Manifest | `subprojects/*.wrap` | `.wrap` dep fetch descriptors. No rule. | - | Not implemented | — | — | — |
| 104 | C / C++ | Config | `configure.ac` / `configure.in` | Autotools dep checks. No rule. | - | Not implemented | — | — | — |
...
| 112 | Swift (CocoaPods) | Manifest | `*.podspec` | No rule. | - | Not implemented | — | — | — |
...
| 115 | Swift (Carthage) | Lockfile | `Cartfile.resolved` | No rule. | - | Not implemented | — | — | — |
...
| 128 | Haskell (Cabal) | Lockfile | `cabal.project.freeze` | No rule. | - | Not implemented | — | — | — |
...
| 134 | Clojure (Boot) | Legacy manifest | `build.boot` | No rule. | - | Not implemented | — | — | — |
| 135 | Lua (LuaRocks) | Manifest | `*.rockspec` | No rule. | - | Not implemented | — | — | — |
| 136 | R | Manifest | `DESCRIPTION` | `Imports:`, `Depends:` fields. No rule. | - | Not implemented | — | — | — |
| 137 | R (renv) | Lockfile | `renv.lock` | No rule. | - | Not implemented | — | — | — |
...
| 143 | Perl | Lockfile | `cpanfile.snapshot` | Carton lockfile. No rule. | - | Not implemented | — | — | — |
| 144 | Perl | Manifest | `Makefile.PL` | ExtUtils::MakeMaker. No rule. | - | Not implemented | — | — | — |
| 145 | Perl | Manifest | `Build.PL` | Module::Build. No rule. | - | Not implemented | — | — | — |
| 146 | Perl | Manifest | `META.json` / `META.yml` | CPAN metadata. No rule. | - | Not implemented | — | — | — |
| 147 | Perl | Config | `dist.ini` | Dist::Zilla. No rule. | - | Not implemented | — | — | — |
| 148 | Raku (Perl 6) | Manifest | `META6.json` | No rule. | - | Not implemented | — | — | — |
...
| 150 | Zig | Config | `build.zig` | Build script referencing packages. No rule. | - | Not implemented | — | — | — |
...
| 153 | OCaml (opam) | Lockfile | `*.opam.locked` | No rule. | - | Not implemented | — | — | — |
| 154 | OCaml (Dune) | Config | `dune-project` | No rule. | - | Not implemented | — | — | — |
| 155 | OCaml (Dune) | Config | `dune` | Per-directory build rules. No rule. | - | Not implemented | — | — | — |
| 156 | OCaml (esy) | Manifest | `esy.json` or `package.json` | npm-style OCaml management. `esy.json` has no rule; `package.json` is covered by JS rule (row 21). | - | Not implemented (esy.json) | — | — | — |
...
| 160 | Crystal | Lockfile | `shard.lock` | No rule. | - | Not implemented | — | — | — |
...
| 163 | Gleam | Lockfile | `manifest.toml` | Gleam lockfile (lowercase). The `julia-manifest` rule matches `^Manifest\.toml$` (capital M) only. No rule for `manifest.toml`. | - | Not implemented | — | — | — |
| 164 | Fortran (fpm) | Manifest | `fpm.toml` | No rule. | - | Not implemented | — | — | — |
