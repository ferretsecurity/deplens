...
| `erlang-rebar-config` | `manifest` | `declaration, constraint` | — | select |
...
| `buf-lock` | `lockfile` | `resolution, integrity` | — | select |
...
| `foundry-toml` | `tool-config` | `configuration` | — | select |
